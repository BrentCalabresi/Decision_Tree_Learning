...
//		Set<Example> examples = problem.readExamplesFromCSVFile(new File(args[0]));
        Set<Example> examples = problem.readExamplesFromCSVFile(new File("C:\\Users\\16kin\\Documents\\CSC 242\\Project4New\\Decision_Tree_Learning\\src\\dt\\example\\WillWait-data.txt"));
